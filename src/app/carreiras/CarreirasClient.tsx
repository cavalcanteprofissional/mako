    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {translate('careers.applyTitle').split(' ').map((word, i, arr) => 
                i === arr.length - 1 ? (
      ...
      <Section padding="lg">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {translate('careers.cultureTitle').split(' ').map((word, i, arr) => 
                i === arr.length - 1 ? (
                  <span key={i} className="text-gradient">{word}</span>
                ) : (
                  word + ' '
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {translate('careers.cultureSubtitle')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card padding="lg" className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{translate('careers.excellence')}</h3>
              <p className="text-gray-600 text-sm">
                {translate('careers.excellenceDesc')}
              </p>
            </Card>
            ...
            <Card padding="lg" className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{translate('careers.innovation')}</h3>
              <p className="text-gray-600 text-sm">
                {translate('careers.innovationDesc')}
              </p>
            </Card>
            ...
            <Card padding="lg" className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{translate('careers.collaboration')}</h3>
              <p className="text-gray-600 text-sm">
                {translate('careers.collaborationDesc')}
              </p>
            </Card>
            ...
            <Card padding="lg" className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{translate('careers.integrity')}</h3>
              <p className="text-gray-600 text-sm">
                {translate('careers.integrityDesc')}
              </p>
            </Card>
          </div>
        </div>
